...
public class TestResourceConstants {
    ...
    public static final String V1_PROJECT_WITH_PAGINATION = "/api/v1/project";
    public static final String V1_PROJECT_WITHOUT_PAGINATION = "/api/v1/project?limit=1000000&offset=0";
