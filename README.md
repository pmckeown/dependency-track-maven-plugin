...
[![Sonarcloud Status](https://sonarcloud.io/api/project_badges/measure?project=io.github.pmckeown:dependency-track-maven-plugin&metric=alert_status)](https://sonarcloud.io/dashboard?id=io.github.pmckeown:dependency-track-maven-plugin)
[![Sonarcloud Status](https://sonarcloud.io/api/project_badges/measure?project=io.github.pmckeown:dependency-track-maven-plugin&metric=reliability_rating)](https://sonarcloud.io/dashboard?id=io.github.pmckeown:dependency-track-maven-plugin)
